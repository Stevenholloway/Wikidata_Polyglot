...
//URL for testing
var tabURL = "https://id.loc.gov/authorities/names/n79007238.html"
...
//failure point -- tabURL variable cannot be passed to item-properties.js outside this function
chrome.runtime.onMessage.addListener(function (request, sender, sendResponse) {
	if (typeof request.mouseoverURL !== 'undefined') {
		tabURL = request.mouseoverURL
    ...
    for (var i = 0; i < Object.keys(language_translations).length; i++) {
      if (typeof language_translations[i].lang !== 'undefined') {
        if (language_translations[i].lang.localeCompare(isoLanguage) == 0) {
          var entity;
          var language;
          select_entity = language_translations[i].entity;
          select_language = language_translations[i].language;
...
//function gettabURL(callback) {
  ...
  //chrome.tabs.query({
    ...
    //currentWindow: true
  //}, function (tabs) {
    //tabURL = decodeURIComponent(tabs[0].url); // e.g. to fix https://
    //callback();
  //});
//}
